...
response = requests.get(f"https://query1.finance.yahoo.com/v7/finance/download/PAYX?period1={YEAR_AGO}&period2={TODAY}&interval=1d&events=history&includeAdjustedClose=true", headers=request_headers)
